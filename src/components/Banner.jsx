  ...
  return (
    ...
    >
      <div className="overflow-hidden lg:relative">
        <ContainerPattern
          size="md"
          className="relative grid grid-cols-1 items-end gap-y-12 pb-8 pt-24 sm:py-10 lg:static lg:grid-cols-2"
        >
          <Pattern className="absolute -top-28 left-0 w-full sm:-top-10 sm:left-3/4 sm:ml-8 sm:w-auto md:left-2/3 lg:left-auto lg:right-2 lg:ml-0 xl:left-2/3 xl:right-auto" />
          <Pattern className="invisible absolute -top-32 left-0 mt-2 w-full sm:visible sm:left-3/4 sm:top-36 sm:ml-8 sm:w-auto md:left-2/3 lg:left-auto lg:right-2 lg:ml-0 xl:left-2/3 xl:right-auto" />
          <div>
