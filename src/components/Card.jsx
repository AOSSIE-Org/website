...
Card.Cta = function CardCta({ href, children }) {
  return (
    <Card.Link href={href}>
      <div
        aria-hidden="true"
        className="relative font-mono z-10 mt-4 flex items-center text-sm font-semibold text-[#00843D] dark:text-yellow-400 cursor-pointer"
      >
        {children}
