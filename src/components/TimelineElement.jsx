...
export function TimelineElement({ title, description, button, time, link, classCondition }) {
    const isExternal = typeof link === 'string' && (link.startsWith('http://') || link.startsWith('https://') || link.startsWith('mailto:'))
    return (
