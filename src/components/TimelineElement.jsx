...
export function TimelineElement({ title, description, button, time, link, classCondition }) {
    const isExternalLink = link !== '/ideas'; // Condition to check if the link should open in a new tab
    return (
