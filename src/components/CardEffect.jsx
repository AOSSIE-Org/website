...
export function CardEffect({heading, content, logo}) {
    return (
        <a className="group relative block h-72 max-lg:w-72 max-xl:w-60 w-72 cursor-pointer">
            ...
            <div className="relative shadow-xl flex h-full justify-center rounded-3xl border-2 border-gray-400 dark:border-gray-200 bg-white dark:bg-gray-800 md:p-8 p-8 px-16 lg:py-8 lg:px-0 xl:p-8">
                <div className="px-8 pb-4 transition-opacity group-hover:absolute group-hover:opacity-0">
                    <Image
                        src= {logo}
                        width={150}
                        unoptimized
                ...
                <div className="absolute pr-6 lg:scale-90 lg:pb-0 lg:pl-3 lg:pr-0 xl:pl-0 md:p-0 md:scale-95 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 dark:text-zinc-300">
                    <p className="mt-4 font-mono">{content}</p>
                </div>
            </div>
        </a>
    )
