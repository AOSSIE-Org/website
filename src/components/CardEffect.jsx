...
export function CardEffect({heading, content, logo}) {
    return (
        <a className="group relative block h-[22rem] max-lg:w-72 max-xl:w-60 w-72 cursor-pointer">
            ...
            <div className="relative shadow-xl flex h-full justify-center rounded-3xl border-2 border-[#00843D] dark:border-yellow-400 bg-white dark:bg-gray-800 md:p-8 p-8 px-16 lg:py-8 lg:px-0 xl:p-8 transition-transform transition-shadow duration-200 ease-out group-hover:-translate-y-1 group-hover:shadow-2xl" style={{ willChange: 'transform, box-shadow' }}>
