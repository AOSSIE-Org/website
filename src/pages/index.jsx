...
import { Skeleton, SkeletonCard, SkeletonGrid, SkeletonText } from '@/components/Skeletons'
  ...
  return (
    <div className="flex flex-col sm:flex-row relative z-10 mb-8">
      <div className="flex-1 self-center">
        <Skeleton width={320} height={300} className="mx-auto scale-110 m-4" />
      </div>
      <div className="mt-10 flex-1 sm:ml-10 lg:ml-0 lg:mt-0 pt-8">
        <div className="max-w-xl ml-12">
          <Skeleton height="3.75rem" width="80%" className="mb-4" />
          <Skeleton height="3.75rem" width="60%" className="mb-8" />
          ...
          <Skeleton height="3rem" width="12rem" className="mt-12 mx-4 md:mx-0" />
        </div>
      </div>
    </div>
  )
  ...
  return (
    <div className="hidden bg-[#3C982C] relative dark:text-black sm:flex flex-col md:flex-row justify-between p-4 sm:p-8 px-4 sm:px-16 text-center border border-white text-white dark:bg-yellow-400 z-20">
      {[
        ...
        { label: 'Community Count', value: '2000+' }
      ].map((stat, i) => (
        <div key={i} className="mb-4 sm:mb-0">
          <Skeleton height="1.5rem" width="6rem" className="mx-auto mb-2" />
    ...
    <div className="mx-auto gap-y-20 lg:max-w-none lg:grid-cols-2">
      <div className="space-y-10">
        <div className="flex text-center items-center justify-center">
          <div className="hidden h-12 w-12 translate-x-px transform items-center justify-center rounded-full bg-[#00843D] p-2 dark:bg-yellow-400 md:flex">
            <Skeleton variant="circular" width="1.5rem" height="1.5rem" className="mx-auto" />
          </div>
          <div className="col-span-8 mt-3 self-center lg:col-start-2">
            <Skeleton height="3rem" width="8rem" className="font-mono pl-3" />
          </div>
        </div>
  ...
  return (
    <>
      ...
      <Container className="mt-24 md:mt-28">
        {isLoading ? <ProjectsSectionSkeleton /> : (
          <div className="mx-auto gap-y-20 lg:max-w-none lg:grid-cols-2">
            <div className="space-y-10 ">
              <div className="flex text-center items-center justify-center">
