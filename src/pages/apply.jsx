        ...
        <Container.Inner className="mt-16">
          ...
          <div className="relative mt-20 block rounded-3xl bg-zinc-400/20 p-8 pb-16 shadow-xl dark:bg-white/70">
            ...
            <div className="mt-10 flex flex-col justify-center gap-6 sm:flex-row">
              <Link
                className="group relative inline-flex items-center overflow-hidden rounded-lg border border-gray-400 bg-white px-8 py-3 font-mono font-semibold text-black transition duration-300 ease-in-out hover:translate-y-[-2px] hover:shadow-lg dark:border-gray-600 dark:bg-zinc-800 dark:text-white dark:hover:shadow-lg"
