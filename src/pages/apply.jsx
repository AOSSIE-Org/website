          ...
          <Container.Inner className='mt-4 mx-4 md:m-16'>
            ...
            <div className="mt-20 relative block rounded-3xl dark:bg-white/70 bg-zinc-400/20 p-8 pb-16 shadow-xl">
              ...
              <div className="mt-10 flex justify-center gap-6 flex-col sm:flex-row">
                <Link className="order-1 group relative rounded-lg inline-flex items-center overflow-hidden bg-white dark:bg-zinc-800 px-8 py-3 text-black dark:text-white focus:outline-none transition-colors duration-200 hover:bg-zinc-100 dark:hover:bg-zinc-700 hover:ring-2 hover:ring-[#3C982C] dark:hover:ring-yellow-400 hover:text-[#3C982C] dark:hover:text-yellow-300" href="https://summerofcode.withgoogle.com/">
