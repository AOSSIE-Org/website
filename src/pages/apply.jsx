        ...
        <Container.Inner className='mt-16'>
          ...
          <div className="mt-20 relative block rounded-3xl dark:bg-white/70 bg-zinc-400/20 p-8 pb-16 shadow-xl">
            ...
            <div className='mt-10 flex justify-center gap-6 flex-col sm:flex-row'>
              <Link className=" order-1 group relative rounded-lg inline-flex items-center overflow-hidden bg-white dark:bg-zinc-800 px-8 py-3 text-black dark:text-white focus:outline-none" href="https://summerofcode.withgoogle.com/" legacyBehavior>
                <span className="font-mono font-semibold text-center">
                  View 2024 Program Announcements
                </span>
              </Link>
              <Link className="order-2 group relative rounded-lg inline-flex items-center overflow-hidden bg-white dark:bg-zinc-800 px-8 py-3 text-black dark:text-white focus:outline-none" href="https://summerofcode.withgoogle.com/programs/2024" legacyBehavior>
                <span className="font-mono font-semibold text-center">
