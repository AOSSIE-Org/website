        ...
        <div className='overflow-x-hidden'>
          ...
          <Container.Inner className='mt-4 mx-4 md:m-16'>
            ...
            <div className="mt-20 relative block rounded-3xl dark:bg-white/70 bg-zinc-400/20 p-8 pb-16 shadow-xl">
              ...
              <Link  className="order-1 group relative rounded-lg inline-flex items-center overflow-hidden bg-white dark:bg-zinc-800 px-8 py-3 text-black dark:text-white focus:outline-none" 
                 href="https://summerofcode.withgoogle.com/"
                 target="_blank"
                 rel="noopener noreferrer"
                 aria-label="View GSoC Program Announcements (opens in new tab)">
