        ...
        <div className="mt-16">
          ...
          >
            {projects.map((project) => (
              <Card as="li" key={project.name} href={project.link.href}>
                ...
                <div className="text-md relative z-10 mt-6 flex font-mono font-semibold text-zinc-600 transition group-hover:text-[#00843D] dark:text-zinc-200 dark:group-hover:text-yellow-400">
