        ...
        <Grid item xs={12} sm={6} md={4} key={index}>
          ...
          >
            ...
            <CardActions sx={{ justifyContent: 'center' }}>
              <a href={project.link.href} className="relative z-10 mt-6 flex text-md font-semibold font-mono text-zinc-600 transition group-hover:text-[#00843D] dark:group-hover:text-yellow-400 dark:text-zinc-200">
