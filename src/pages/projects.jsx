      ...
      <Container className="mt-20 mb-28">
        <div className="mt-5">
          <p className="text-zinc-600 dark:text-zinc-400 text-lg font-mono leading-7">
            Our Projects, where we showcase our tech wizardry and code-slinging skills! <br /> Our portfolio is a treasure trove of open-source gems, featuring projects in a variety of languages and areas. Take a peek and see how we&apos;re making a difference with our technical spells.
          </p>
        </div>
        <div className="mt-16">
          ...
          <ul role="list" className="grid grid-cols-1 gap-x-12 gap-y-16 sm:grid-cols-2 lg:grid-cols-3 mt-12 mb-16">
            {projects.map((project) => (
              <Card as="li" key={project.name} className="border border-zinc-300 dark:border-zinc-700 rounded-lg p-4">
