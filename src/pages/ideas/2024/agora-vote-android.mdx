...
export const meta = {
  ...
  difficulty: '',
  outcomes:
    'Migration to Jetpack-Compose and Material-You support, Implement CI/CD pipeline to automate the android release, Share the election results with visualization, Implement remaining ballots, TDD is preferred but you can write the tests later',
  mentors: 'Amit Kumar, Abhishek Agarwal',
  skills:
    'Android developement (Kotlin), Jetpack Compose, UI/UX design, Familiar with REST',
}
