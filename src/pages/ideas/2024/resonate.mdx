...
export const meta = {
  ...
  difficulty: '',
  outcomes:
    'Imporve the user experience, Mitigate known/unknown security vulnerabilities, Make the application production ready, Deploy the application to play store',
