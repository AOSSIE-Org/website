...
export const meta = {
  ...
  projectDuration: '175 hrs',
    difficulty: '',
  outcomes:
    'Redesign and improve the user interface, Imporve the user experience, Work on dynamic theming (users should be able to customize colour scheme based on their preference)',
  mentors: 'Jaideep Prasad',
  skills: 'Flutter, Figma (or any other design tool)'
}
